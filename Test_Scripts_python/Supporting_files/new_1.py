...
try:
    ...
    try:
        ...
        if suggestion_list_odkud:
            first_suggestion_odkud = suggestion_list_odkud.find_element(By.CSS_SELECTOR, ".idos-autosuggest__suggestion")
            first_suggestion_odkud.send_keys(Keys.ARROW_UP)
            time.sleep(0.5)
            first_suggestion_odkud.click()
            print(
    ...
    try:
        suggestion_list_kam = wait.until(
            EC.visibility_of_element_located((By.CSS_SELECTOR, ".idos-autosuggest__suggestions-container"))
        )
        if suggestion_list_kam:
            first_suggestion_kam = suggestion_list_kam.find_element(By.CSS_SELECTOR, ".idos-autosuggest__suggestion")
            first_suggestion_kam.click()
            print(
